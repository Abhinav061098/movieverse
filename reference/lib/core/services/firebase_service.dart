...
class FirebaseService {
  ...
  Future<void> initialize() async {
    try {
      ...
      print(
          'Firebase Database initialized with URL: ${FirebaseDatabase.instance.databaseURL}');
  ...
  Future<void> logEvent(String name, Map<String, dynamic> parameters) async {
    try {
      // Sanitize parameters to ensure they are either strings or numbers
      ...
      await analytics.logEvent(name: name, parameters: sanitizedParams);
    } catch (e) {
      debugPrint('Error logging analytics event: $e');
      // Don't rethrow - analytics errors shouldn't crash the app
    }
  }
